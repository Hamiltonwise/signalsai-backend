...
import networkIntelligenceRoutes from "./routes/user/networkIntelligence";
...
app.use("/api/user", networkIntelligenceRoutes); // Network intelligence: collective heuristics, seasonal, drift, themes
