  ...
  try {
    ...
    const updatedCheckupData = {
      ...
      place: {
        ...
        hasWebsite: freshWebsite,
        hasEditorialSummary: freshEditorial,
        regularOpeningHours: freshPlace.regularOpeningHours || null,
        phone: freshPlace.nationalPhoneNumber || freshPlace.internationalPhoneNumber || null,
        websiteUri: freshPlace.websiteUri || null,
        editorialSummary: freshPlace.editorialSummary || null,
      },
      score: {
        composite: newScore,
