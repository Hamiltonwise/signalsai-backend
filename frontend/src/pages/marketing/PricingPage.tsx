    ...
    >
      ...
      <section className="px-5 py-16 sm:py-24">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="mt-4 text-base sm:text-lg text-[#1A1D23]/60">
            One product. One price. No contracts.
          </p>
        </div>
      </section>
      ...
      <section className="px-5 pb-16 sm:pb-20">
        <div className="max-w-lg mx-auto">
          <div className="rounded-2xl border-2 border-[#212D40]/15 bg-white overflow-hidden shadow-sm">
            ...
            <div className="p-8">
              ...
              <div className="text-center mb-8">
                <span className="text-5xl sm:text-6xl font-semibold text-[#1A1D23]">
                  $2,000
                </span>
              ...
              <div className="space-y-6">
                <IncludeItem
                  title="Your Monday Brief every Monday morning."
          ...
          <div className="mt-8 rounded-xl border-2 border-[#212D40]/10 bg-[#212D40]/[0.02] p-6 text-center">
            ...
            <p className="text-xs text-[#1A1D23]/50 leading-relaxed">
...
function IncludeItem({ title, desc }: { title: string; desc: string }) {
  return (
    <div>
      <p className="text-sm font-semibold text-[#1A1D23] mb-1">{title}</p>
      <p className="text-sm text-[#1A1D23]/60 leading-relaxed">{desc}</p>
    </div>
  );
}
