      ...
      <main className="w-full max-w-[1100px] mx-auto px-6 lg:px-10 py-12 space-y-12">
        ...
        <section className="animate-in fade-in slide-in-from-bottom-2 duration-700 text-left">
          <div className="flex items-center gap-6 mb-8">
            <div className="w-20 h-20 rounded-2xl bg-alloro-orange text-white flex items-center justify-center text-4xl font-semibold shadow-lg">
              {userProfile?.firstName?.charAt(0).toUpperCase()}
              {userProfile?.lastName?.charAt(0).toUpperCase()}
            </div>
            <div className="flex-1">
              <h2 className="text-3xl font-semibold font-heading text-alloro-textDark tracking-tight">
        ...
        <section className="bg-white rounded-3xl border border-black/5 shadow-premium overflow-hidden">
          <div className="px-8 lg:px-12 py-8 border-b border-black/5 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-semibold font-heading text-alloro-textDark tracking-tight">
                Account Information
              </h3>
            </div>
            {!isEditing && (
              <button
                ...
                className="px-5 py-2.5 bg-alloro-orange text-white rounded-xl text-xs font-semibold uppercase tracking-widest hover:shadow-lg transition-all active:scale-95"
              >
                Edit Profile
              </button>
            )}
            ...
            {isEditing ? (
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="text-xs font-semibold text-alloro-textDark/60 uppercase tracking-widest mb-2 block">
                      First Name
                    </label>
                    <input
                      type="text"
                ...
                <div className="flex gap-4 justify-end pt-4">
                  <button
                    ...
                    className="px-6 py-3 bg-slate-100 text-alloro-textDark rounded-xl text-xs font-semibold uppercase tracking-widest hover:bg-slate-200 transition-all"
                  >
                    Cancel
                  </button>
                  <button
                    onClick={handleSave}
                    disabled={saving}
                    className="px-6 py-3 bg-alloro-orange text-white rounded-xl text-xs font-semibold uppercase tracking-widest hover:shadow-lg transition-all flex items-center gap-2 disabled:opacity-60"
                  >
        ...
        <section className="bg-white rounded-3xl border border-black/5 shadow-premium overflow-hidden">
          ...
          <div className="p-8 lg:p-12">
            <button
              ...
              className="w-full py-4 px-6 bg-red-50 border-2 border-red-200 rounded-2xl text-red-600 font-semibold text-sm uppercase tracking-widest hover:bg-red-100 transition-all flex items-center justify-center gap-3 active:scale-95"
            >
              <LogOut size={18} />
