  ...
  switch (reason) {
    case "not_using":
      return {
        ...
        body: `If ${orgName}'s intelligence hasn't been useful, that's worth fixing. The dashboard has a walkthrough of this month's findings. Or you can pause and come back when you're ready.`,
        offerPause: true,
        offerHelp: true,
      };
    case "too_expensive":
