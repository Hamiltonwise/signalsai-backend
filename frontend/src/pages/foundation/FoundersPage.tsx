      ...
      <section className="px-6 py-20 max-w-3xl mx-auto">
        ...
        <div className="mt-12 space-y-8">
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-bold text-[#212D40]">Market Intelligence</h3>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-bold text-[#212D40]">Founder Network</h3>
              <p className="text-sm text-gray-500 mt-1">
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-bold text-[#212D40]">Launch Accelerator</h3>
              <p className="text-sm text-gray-500 mt-1">
