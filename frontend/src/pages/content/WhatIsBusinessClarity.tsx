...
export default function WhatIsBusinessClarity() {
  ...
  return (
    <MarketingLayout
      title="Business Clarity: What It Is, Why It's Rare, and What Changes When You Have It"
      description="Business clarity means knowing what is happening in your business, what it means, and what the one move is that changes your position. Learn why most small business owners have data but not clarity."
    >
      <script
