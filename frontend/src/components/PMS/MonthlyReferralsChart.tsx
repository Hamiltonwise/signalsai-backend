    ...
    <div className="flex flex-col gap-6">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-end justify-between">
            <div>
              <div className="text-4xl font-semibold font-heading tracking-tight mb-1">
      ...
      >
        <div className="px-6 py-5 border-b border-slate-100 flex justify-between items-center bg-slate-50/50 rounded-t-2xl">
          <h3 className="font-semibold text-alloro-navy font-heading">
            Monthly Trend
          </h3>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="flex items-center gap-2 h-5">
                        <motion.div
                          ...
                          className="h-full bg-alloro-orange rounded-r-md text-xs text-white font-semibold flex items-center justify-end px-2 shadow-sm shadow-blue-200 transition-all duration-300 group-hover:bg-blue-700"
                        >
                      ...
                      {item.doctorReferrals > 0 && (
                        <div className="flex items-center gap-2 h-5">
                          <motion.div
                            ...
                            className="h-full bg-alloro-teal rounded-r-md text-xs text-white font-semibold flex items-center justify-end px-2 shadow-sm shadow-teal-200 transition-all duration-300 group-hover:brightness-110"
                          >
