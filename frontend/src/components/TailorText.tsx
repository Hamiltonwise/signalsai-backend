...
export function TailorText({
  ...
  return (
    ...
    >
      ...
      {showSaved && (
        <span className="absolute -top-6 left-1/2 -translate-x-1/2 bg-emerald-600 text-white text-xs font-semibold px-2 py-0.5 rounded-full shadow-sm whitespace-nowrap animate-fade-in">
          Saved
        </span>
      )}
    </Tag>
