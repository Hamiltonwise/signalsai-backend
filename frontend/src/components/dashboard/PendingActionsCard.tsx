...
export default function PendingActionsCard({ orgId }: { orgId: number }) {
  ...
  // No pending actions: show nothing. The old "Alloro is working" card
  // was a permanent false promise when no DFY pipeline is active
  // (GBP posts deprecated, no OAuth for review responses).
  // The card only appears when there ARE actions to approve.
