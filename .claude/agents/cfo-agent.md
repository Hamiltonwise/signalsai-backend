...
Stage model:
- Stage 1 (Checkup only): $0 MRR, low switching cost, high churn risk
- Stage 2 (GBP connected): $150/month, moderate switching cost
- Stage 3 (PMS connected): $300/month, high switching cost (referral data is irreplaceable)
- Stage 4 (PatientPath live): $500/month, very high switching cost (website + data + intelligence)

Unit economics:
- CAC target: under $200 (3-month payback at $150/month Stage 2)
- LTV target: $3,600+ (24-month average retention at Stage 2+)
- NRR target: 115%+ (driven by stage progression, not upsells)
